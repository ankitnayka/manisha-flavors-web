...
const menuData: MenuSection[] = [
  {
    ...
    icon: "⭐",
    items: [
      { name: "Chhole Bhature", price: "₹60.00", image: "/src/assets/menuItems/cholebhature.png" },
      { name: "Butter Chhole Bhature", price: "₹80.00", isPopular: true, image: "/src/assets/menuItems/butterChole.png" },
      { name: "Cheese Chhole Bhature", price: "₹80.00", image: "/src/assets/menuItems/cheeschole.png" },
      { name: "Butter Cheese Chhole Bhature", price: "₹100.00", image: "/src/assets/menuItems/butterchesschole.png" },
    ],
  },
  ,
  {
    ...
    items: [
      {
        ...
        isUnlimited: true,
        isPopular: true,
        image: "/src/assets/menuItems/gujaratithali.png",
      },
    ],
  },
  {
    ...
    icon: "🥘",
    items: [
      { name: "Roasted Papad", price: "₹12.00", image: "/src/assets/menuItems/rostedpapad.png" },
      { name: "Fried Papad", price: "₹15.00", image: "/src/assets/menuItems/friedpapad.png" },
      { name: "Masala Papad", price: "₹25.00", isPopular: true, image: "/src/assets/menuItems/masalapapad.png" },
  ...
  },
  {
    ...
    icon: "🍚",
    items: [
      { name: "2 Sabji (Unlimited) + 4 Chapati", price: "₹80.00", isUnlimited: true, image: "/src/assets/menuItems/twosak.png" },
      { name: "Plain Chapati", price: "₹6.00", image: "/src/assets/menuItems/planechapati.jpg" },
      { name: "Dal-Rice", price: "₹40.00", image: "/src/assets/menuItems/dalrice.png" },
      { name: "Butter Chapati", price: "₹8.00", image: "/src/assets/menuItems/ButterRoti.jpg" },
      { name: "Paratha", price: "₹15.00", image: "/src/assets/menuItems/paratha.jpg" },
    ],
  },
  {
    title: "Extras",
    icon: "🧈",
    items: [
      { name: "Bhature", price: "₹20.00", image: "/src/assets/menuItems/bhature.png" },
      { name: "Butter", price: "₹20.00", image: "/src/assets/menuItems/butter.png" },
      { name: "Cheese", price: "₹20.00", image: "/src/assets/menuItems/chees.png" },
    ],
  },
  {
    title: "Beverages",
    icon: "🥤",
    items: [
      { name: "Masala Buttermilk", price: "₹20.00", image: "/src/assets/menuItems/buttermilk.png" },
      { name: "Buttermilk", price: "₹15.00", image: "/src/assets/menuItems/buttermilk1.png" },
      { name: "Mineral Water", price: "As per MRP", image: "/src/assets/menuItems/waterbottle.png" },
      { name: "Cold Drinks", price: "As per MRP", image: "/src/assets/menuItems/colddrink.png" },
    ],
  },
];
...
//     icon: "🍚",
//     items: [
//       { name: "2 Sabji (Unlimited) + 4 Chapati", price: "₹40.00", isUnlimited: true,image:"/src/assets/menuItems/twosak.png" },
//       { name: "Plain Chapati", price: "₹6.00",image:"/src/assets/menuItems/planechapati.jpg" },
//       { name: "Dal-Rice", price: "₹40.00",image:"/src/assets/menuItems/dalrice.png" },
//       { name: "Butter Chapati", price: "₹8.00" ,image:"/src/assets/menuItems/ButterRoti.jpg"},
//       { name: "Paratha", price: "₹15.00" ,image:"/src/assets/menuItems/paratha.jpg"},
